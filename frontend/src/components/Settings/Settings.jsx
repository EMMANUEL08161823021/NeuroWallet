...
export default function Settings() {
  ...
  const handleLogout = () => {
    ...
    // Optionally, clear app state if using context
    // e.g., setUser(null), setWallet([])
  ...
  return (
    <div className="p-6 h-screen rounded-lg shadow-md max-w-lg mx-auto border-2 border-black space-y-4">
      ...
      <section className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
        ...
        <button onClick={handleLogout} className="w-full mt-2 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700">
          Logout
        </button>
      </section>
    </div>
